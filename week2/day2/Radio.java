...
public class Radio {
	...
	public static void main(String[] args) {
		// To Launch Browser,Load URL, maximize and implicitly wait
				...
				boolean DefaultBrowser = driver.findElement(By.xpath("//h5[contains(text(),'Find the default')]/following::div[contains(@class,'default ui')]")).isEnabled();
				String DefaultOption = null;
				if (DefaultBrowser == true) {
					DefaultOption = driver.findElement(By.xpath("//h5[contains(text(),'default')]/following::input[@checked='checked']")).getAttribute("value");
				...
				boolean AgeRadio = driver.findElement(By.xpath("//h5[contains(text(),'age')]/following::label[text()='21-40 Years']")).isEnabled();
				if (AgeRadio == true) {
